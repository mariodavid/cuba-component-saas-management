...
public class CcsmTestContainer extends TestContainer {

    public CcsmTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/ccsm/app.properties",
    ...
    public static class Common extends CcsmTestContainer {

        public static final CcsmTestContainer.Common INSTANCE = new CcsmTestContainer.Common();
